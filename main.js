...
async function logout() {
  ...
  async function deleteBook(bookId){
    ...
    await axios.delete('http://api.marketube.tv/v1/book/${bookId}',{
        headers:{
            Authorization:'Bearer ${token}',
            //토큰이 유효하면
        },
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <div class="btn-group">
              ...
              <button type="button" class="btn btn-sm btn-outline-secondary btn-delete" data-book-id="${book.bookId}">delete</button>
            </div>
...
async function main(){
    ...
    //나의 책을 서버에서 받아오기
    const books= await getBook(token);
    if(books===null){
        return;
    }
